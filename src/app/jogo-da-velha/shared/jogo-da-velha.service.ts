...
export class JogoDaVelhaService {
  ...
  /**
   * Inicializa o jogo.
   * Define exebição da tela inicial
   */
  inicializar(): void {
  ...
  /**
   * inicializa o tabuleiro do jogo com zavio em todas a posições
   */
  ...
  /**
   * Retorna o valor variavel showInicio
   * @returns {boolean}
   */
  ...
  /**
   * Retorna o valor variavel showTabuleiro
   * @returns {boolean}
   */
  ...
  /**
   * Retorna o valor variavel showFinal
   * @returns {boolean}
   */
